export const projects = [
  {
    title: 'Estima',
    description: 'Estima é um Planning Poker gratuito e em tempo real, criado para ajudar equipes ágeis a fazer estimativas de forma simples, colaborativa e sem burocracia.',
    image: '/images/estima.png',
    tags: ['NextJS', 'Tailwind', 'Firebase'],
    codeUrl: 'https://github.com/nettobruno/estima',
